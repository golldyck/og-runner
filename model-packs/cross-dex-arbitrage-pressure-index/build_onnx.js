...
function buildONNX(inputName, outputName, numFeatures) {
  ...
  const graph = [
    ...
    ...node2,
    ...node3,
    ...writeString(2, 'cross_dex_arbitrage_pressure_graph'),
  ...
  const model = [
    ...writeInt64Field(1, 7),
    ...writeInt64Field(5, 9),
    ...writeString(2, 'cross-dex-arbitrage-pressure-index'),
    ...graphProto,
  ]
...
const outputPath = path.join(__dirname, 'cross-dex-arbitrage-pressure-index.onnx')
const bytes = buildONNX('features', 'arbitrage_pressure_score', 20)
